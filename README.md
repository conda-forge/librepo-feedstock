...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/librepo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/librepo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add librepo py-librepo
# for installing globally
pixi global install librepo py-librepo
```
...
It is possible to list all of the versions of `librepo` available on your platform:
...
```
pixi search librepo --channel conda-forge
```
